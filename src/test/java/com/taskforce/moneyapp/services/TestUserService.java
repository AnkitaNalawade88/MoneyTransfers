...
public class TestUserService extends TestService {
    ...
    */
    ...
    public void testGetUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/user/Ankita").build();
        ...
        assertTrue(user.getUserName().equals("Ankita"));
        assertTrue(user.getEmailAddress().equals("ankita@gmail.com"));
    }
    ...
    public void testCreateUser() throws IOException, URISyntaxException {
        ...
        User user = new User("adyah", "adyah@gmail.com");
        ...
        assertTrue(uAfterCreation.getUserName().equals("adyah"));
        assertTrue(uAfterCreation.getEmailAddress().equals("adyah@gmail.com"));
    }
